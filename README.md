...
チームメンバーは10人  
このゲームは2017年度の日本ゲーム大賞アマチュア部門に応募し最終選考まで残りました。  
...
2.インストーラーがDLできたら実行し、インストールが完了するまで待ちます。  
...
This game supports both gamepads and keyboard/mouse controls (Gamepad recommended).  
Controls are explained during Stage 1.  
